...
#define FLASH_PAGE_SIZE         0x800U      // F1每页固定2KB

#define USER_APP1_STRAT_ADDR 0x8008000
#define USER_APP2_STRAT_ADDR 0x8044000
#define USER_APP1_START_SIZE    0x3C000U
#define USER_APP2_START_SIZE    0x3C000U
